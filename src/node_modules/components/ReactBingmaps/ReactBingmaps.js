...
class ReactBingmaps extends Component {
	...
	componentWillReceiveProps(nextProps){
		...
		if(this.props.heading !== nextProps.heading){
			console.log("IN: "+str(nextProps.heading))
			this.setHeading(nextProps.heading, mapReference);
		}
	...
	setHeading(heading, mapReference){
		if(map[mapReference] && heading){
			map[mapReference].setView({heading: heading});
		}
	}
